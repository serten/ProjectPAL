...
$queryStr="INSERT INTO ALERTZONE ( USERID, ZONECREATETIME, ZONEACTIVATED, ZONECOORDINATES)VALUES('$u_id',TIMESTAMP'$date','0',ST_GeomFromText('POLYGON((";
	
for($i=0;$i<count($polygon);$i++)
{	
    $queryStr=$queryStr.$polygon[$i][0]." ".$polygon[$i][1].",";
}
$queryStr=$queryStr.$polygon[0][0]." ".$polygon[0][1]."))', 4326))";
